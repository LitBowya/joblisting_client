...
import { resetPassword, resendOtp } from "@/app/(auth)/authActions";
...
const ResetPasswordForm = ({ email, onClose }: ResetPasswordFormProps) => {
  const form = useForm({
    defaultValues: {
      otp: "",
      email,
    ...
    <div className="p-6 space-y-6">
      <Form {...form}>
        <form action={formAction} className="space-y-4">
          ...
          <SubmitButton text="Reset Password" isSubmitting={pending} />
        </form>
      </Form>
