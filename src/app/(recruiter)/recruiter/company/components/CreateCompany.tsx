...
import { createCompany } from "@/app/(recruiter)/recruiter/company/companyActions";
import type { CreateCompanyState } from "@/types/company";
  ...
  return (
    <div>
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent>
          <div className="p-2">
            <DialogTitle className="text-lg font-semibold">Create Company</DialogTitle>
            <Form {...form}>
